...
#email connection information for sending study invitations
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'FILL HERE' #just using my nau email for testing. dont fucking log into my email lol.
EMAIL_HOST_PASSWORD = 'FILL HERE'

#admins list for the django rest api
ADMINS = ((''),)
MANAGERS = ADMINS

#Fitbit App client id and secret
CLIENT_ID = 'FILL HERE'
CLIENT_SECRET = 'FILL HERE'

#database uri for sql alchemy connections
DATABASE_URI = 'FILL HERE'
