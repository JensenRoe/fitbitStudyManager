...
client_id = 'FILL CLIENT ID HERE'
client_secret = 'FILL SECRET KEY HERE'
fitbit_auth_url = 'https://www.fitbit.com/oauth2/authorize'
fitbit_auth_token = 'https://api.fitbit.com/oauth2/token'
DATABASE_URI = 'FILL DATABASE URI HERE'
...
app.config['MAIL_USERNAME'] = 'FILL EMAIL HERE'
app.config['MAIL_PASSWORD'] = 'FILL PASSWORD HERE'
...
def index():
    ...
    msg = Message("You have been invited to participate in a study!",
                  sender = "FILL EMAIL HERE",
                  recipients = ["FILL EMAIL HERE"])
